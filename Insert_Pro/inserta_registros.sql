...
--Persona perdida antes de diego, persona con id = 8
...
--Id empleado 8
SELECT INSERTA_USUARIO(8,1,2,'RDGARCIA8', 'PASSWORD', 'RESPUESTA');
SELECT INSERTA_PUESTO_PERSONA(8, 6, '2017-01-01');
SELECT INSERTA_EDUCACION_PERSONA(8, 2, '2013-11-04', '2016-09-09', 'ARCHIVO');
SELECT INSERTA_CURSO_PERSONA(8, 1, '2010-08-01', '2012-07-11', 'PROBATORIO');
