...
(ID_PERSONA, NOMBRE, APELLIDO_PATERNO, APELLIDO_MATERNO, TELEFONOS, CORREOS,
	...
	USUARIO, PASSWORD, ID_EDUCACION, ULTIMO_GRADO_ESTUDIOS, ID_GRADO, GRADO
)
AS
SELECT P.ID_PERSONA, P.NOMBRE, P.AP_PATERNO, P.AP_MATERNO,
	...
	US.USUARIO, US.PASSWORD, ED.ID_EDUCACION, ED.NOMBRE AS ULTIMO_GRADO_ESTUDIOS, GR.ID_GRADO, GR.NOMBRE AS GRADO
FROM PERSONA P
